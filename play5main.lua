...
local function f_center_pos()
	...
	local index2 = skin_config.option["Lane Center & Notes Position"]
...
local filepath = {
	...
	{name = "Notes: 3", 							category = "pl_notes_3", path = "parts/notes/yellow/*.png", def = "Square_White#f3f3f3"},
	{name = "Notes: Scratch", 						category = "pl_notes_4", path = "parts/notes/scratch/*.png", def = "Square_Red#fc0014"},
	
	{name = "Keybeam: 1-5", 						category = "pl_keybeam_1", path = "parts/keybeam/white/*.png", def = "Default_Wh"},
	{name = "Keybeam: 2-4", 						category = "pl_keybeam_2", path = "parts/keybeam/blue/*.png", def = "Default_Bl"},
	{name = "Keybeam: 3", 							category = "pl_keybeam_3", path = "parts/keybeam/yellow/*.png", def = "Default_Wh"},
